...
public class Shop extends Group {
    ...
    public Shop(final Hero hero) {
        ...
        //создаем массив из ламп(улучшения красные -зеленые)
        ...
        //создаем массив кнопок (кол зависит от массива скиллов)
